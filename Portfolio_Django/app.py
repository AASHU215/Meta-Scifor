...
app.config['MAIL_SERVER'] = 'aashu0521@gmail.com'
app.config['MAIL_PORT'] = 465
app.config['MAIL_USE_SSL'] = True
app.config['MAIL_USERNAME'] = 'aashu0521@gmail.com'
app.config['MAIL_PASSWORD'] = 'aashu0521'
...
def msg():
    if request.method == 'POST':
        ...
        msg = Message(subject='Contact Form',
                  ...
                  recipients=['aashu0521@gmail.com'],
                  body=f'From: {name}\nEmail: {email}\nMessage: {msg}')
        mail.send(msg) 
